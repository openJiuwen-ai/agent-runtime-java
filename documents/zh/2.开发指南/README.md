...
| 5 | [A2A 与平台边界](A2A与平台边界.md) → [A2A 开发指导](A2A开发指导.md) | 需要 A2A 时 |
...
- 本仓 **已交付进程内 A2A**（Agent Card、JSON-RPC）；**平台级**多 Agent 路由与独立 `a2a_service` 进程仍属规划，见 [A2A 与平台边界](A2A与平台边界.md)。
...
| [A2A](A2A/README.md) | 进程内 vs 平台 | [A2A 与平台边界](A2A与平台边界.md)、[A2A 开发指导](A2A开发指导.md) |
