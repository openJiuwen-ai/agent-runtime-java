...
class A2aInterruptScenarioTest {
    ...
    static void startAgents() {
        ...
        agentA = new SpringApplicationBuilder(AgentAApp.class).sources(StubAgentTestConfig.class).profiles("agent-a")
                .run("--server.port=0", "--openjiuwen.service.a2a.remote-agents[0].url=" + urlB + "/a2a/");
