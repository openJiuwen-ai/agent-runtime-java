...
public class AgentCardController {
    ...
    private AgentCard buildCard(HttpServletRequest request) {
        ...
        return new AgentCard(properties.getAgentName(), properties.getAgentDescription(),
                ...
                properties.getDefaultInputModes(), properties.getDefaultOutputModes(), skills, Map.of(), // securitySchemes
                                                                                                         // (P0)
                List.of(), // securityRequirements (P0)
                properties.getIconUrl(), List.of(new AgentInterface("JSONRPC", jsonRpcUrl, null, "1.0")), List.of(), // signatures
