 ...
 * {@code max(64, CPU×8)} worker threads plus an {@link ArrayBlockingQueue} with a default capacity of 128.
...
final class QuerySsePumpExecutor {
    ...
    private static final int DEFAULT_MAX_SIZE = Math.max(64, Runtime.getRuntime().availableProcessors() * 8);
