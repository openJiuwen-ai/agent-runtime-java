...
public interface MiddlewareAdapterRegistrar {
    ...
    /**
     * Optional override/extension of Core Factory providers. P0 relies on ServiceLoader defaults.
     */
    default void registerFactories() {
    }

    /**
     * Populates checkpointer (and P2 placeholder fields) on the global runner configuration.
     */
