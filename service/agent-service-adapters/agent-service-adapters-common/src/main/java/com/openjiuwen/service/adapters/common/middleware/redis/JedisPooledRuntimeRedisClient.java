...
/**
 * {@link RuntimeRedisClient} backed by Jedis' pooled command client.
 *
 * @since 0.1.0
 */
public class JedisPooledRuntimeRedisClient implements RuntimeRedisClient {
    private static final int SCAN_COUNT = 100;

    private final JedisPooled delegate;
