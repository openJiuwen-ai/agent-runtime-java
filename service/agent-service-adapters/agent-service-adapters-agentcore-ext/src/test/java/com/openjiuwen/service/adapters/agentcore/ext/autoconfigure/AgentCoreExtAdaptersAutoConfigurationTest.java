...
class AgentCoreExtAdaptersAutoConfigurationTest {

    private final ApplicationContextRunner contextRunner = new ApplicationContextRunner()
            .withConfiguration(AutoConfigurations.of(AgentCoreExtAdaptersAutoConfiguration.class));

    @Test
    void registersJiuwenCoreExtAgentHandlerWhenConfigured() {
        contextRunner
                .withPropertyValues(
                        "openjiuwen.service.agent-id=my-agent",
                        "openjiuwen.service.handler=agentcore-ext")
                .run(context -> assertThat(context.getBean(AgentHandler.class))
                        .isInstanceOf(JiuwenCoreExtAgentHandler.class));
    }

    @Test
    void skipsWhenHandlerIsAgentcore() {
        contextRunner
                .withPropertyValues(
                        "openjiuwen.service.agent-id=my-agent",
