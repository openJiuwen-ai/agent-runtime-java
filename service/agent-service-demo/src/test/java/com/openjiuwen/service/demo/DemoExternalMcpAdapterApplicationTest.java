...
@SpringBootTest(classes = {
        DemoAgentApplication.class,
        DemoExternalMcpAdapterApplicationTest.ExternalAdapterTestConfig.class
}, properties = {
        "openjiuwen.demo.llm.enabled=true",
        "openjiuwen.demo.llm.provider=DemoExternalMcpProvider",
        "openjiuwen.demo.llm.api-key=test-key",
        "openjiuwen.demo.llm.api-base=mirror://demo-external-mcp",
        ...
        "openjiuwen.service.external.mcp.timeout-ms=1500",
